...
const IngredientWithAmountForFeed = ({ingredientWithAmount}: {ingredientWithAmount: IngredientWithAmount}) => {

  return (
    <div className={styles.container}>
      <div className={styles.image_name}>
        <div className={styles.ingredient_image}>
          <img src={ingredientWithAmount.ingredient.image_mobile}
               alt={ingredientWithAmount.ingredient.name} />
        </div>
        <p className="text text_type_main-default ml-5">
          { ingredientWithAmount.ingredient.name }
        </p>
      </div>
      <div className={styles.amount_price}>
        <p className="text text_type_digits-default">
          { ingredientWithAmount.amount }
        </p>
